...
=== Troubleshooting
===== DSE Pod in Pending State for ~10 minutes

1. Check for the labels. If they are in ReadytoStart we need to overwrite to Starting
...
2. Compare the capacity of the new nodes with the cordoned ones. 
